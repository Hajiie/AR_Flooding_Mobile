...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.ARStarterAssets
{
    ...
    public class ARFeatheredPlaneMeshVisualizer : MonoBehaviour
    {
        ...
        {
            get { return m_FeatheringWidth; ***REMOVED***
            set { m_FeatheringWidth = value; ***REMOVED***
        ***REMOVED***
        ...
        ***REMOVED***
        ...
        void GenerateBoundaryUVs(Mesh mesh)
        {
            ...
            if (s_FeatheringUVs.Capacity < vertexCount) { s_FeatheringUVs.Capacity = vertexCount; ***REMOVED***
            ...
            for (int i = 0; i < vertexCount - 1; i++)
            {
                ...
                if (shortestUVMapping > uvMapping) { shortestUVMapping = uvMapping; ***REMOVED***
