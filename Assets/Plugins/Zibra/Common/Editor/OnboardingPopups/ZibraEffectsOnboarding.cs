...
namespace com.zibra.common.Editor
{
    internal class ZibraEffectsOnboarding : EditorWindow
    {
            ...
            ***REMOVED***
            ...
            for (int i = 0; i < (int)Effect.Count; ++i)
            {
                ...
                if (PluginManager.IsAvailable(effect) && !LicensingManager.Instance.IsLicenseVerified(effect))
                {
                    ...
                    ZibraEffectsOnboarding window = CreateWindow<ZibraEffectsOnboarding>($"Activate Zibra {effect***REMOVED***");
            ...
            ***REMOVED***
            ...
            switch (EffectToActivate)
            {
                ...
                case Effect.Smoke:
                    ...
                    break;
                default:
                    throw new ArgumentException($"Invalid Effect Type {EffectToActivate***REMOVED***");
            ***REMOVED***
#endif
            ...
            root.Query<TextElement>().ToList().ForEach(e => { e.text = e.text.Replace("!ProductName", ProductName); ***REMOVED***);
        ...
        ***REMOVED***
        ...
        {
            const string ORDER_NUMBER_REGEX = "^(\\d{13,14***REMOVED***)|(IN\\d{12***REMOVED***)$";
...
#if !ZIBRA_EFFECTS_OTP_VERSION
            LicensingManager.Instance.ValidateLicense(key, new Effect[] { Effect.Liquid, Effect.Smoke, Effect.ZibraVDB ***REMOVED***);
#else
