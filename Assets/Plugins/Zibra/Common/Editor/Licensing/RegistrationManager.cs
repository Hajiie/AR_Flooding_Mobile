...
namespace com.zibra.common.Editor.SDFObjects
{
    ...
    class RegistrationManager
    {
        ...
        ***REMOVED***
        ...
        /// </summary>
        public Status CurrentStatus { get; private set; ***REMOVED*** = Status.NotRegistered;
        public static RegistrationManager Instance { get; private set; ***REMOVED*** = new RegistrationManager();
        public bool IsFirstRegistration { get; private set; ***REMOVED*** = false;
        ...
        ***REMOVED***
        ...
        /// </summary>
        public string ErrorMessage { get; private set; ***REMOVED*** = "";
