...
#region Public Interface
        ...
        /// </summary>
        public static GenerationManager Instance { get; private set; ***REMOVED*** = new GenerationManager();
        ...
        ***REMOVED***
        ...
        public string GetGenerationURL()
        {
            ...
            ***REMOVED***
            ...
            return $"https://generation.zibra.ai/api/unity/compute?hardware_id={GetHardwareID()***REMOVED***&api_key={GetGenerationKey()***REMOVED***";
        ***REMOVED***
