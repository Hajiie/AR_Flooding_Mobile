        ...
        ***REMOVED***
        ...
        public string GetInfo(Effect effect)
        {
            ...
            ***REMOVED***
            ...
            return $"Seats: {licenseInfo.seats***REMOVED***\nAllowed computers limit: {licenseInfo.hardware_allowed***REMOVED***\nComputers activated on: {licenseInfo.hardware_activated***REMOVED***\n";
        ***REMOVED***
