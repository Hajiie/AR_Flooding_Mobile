...
namespace com.zibra.common.Foundation.Editor
{
    ...
    internal static class UIToolkitEditorUtility
    {
        ...
        {
            var uxmlPath = $"{path***REMOVED***.uxml";
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(uxmlPath);
            if (visualTree == null)
            {
                Debug.LogError($"Failed to load VisualTreeAsset at path: {uxmlPath***REMOVED***");
                return;
            ***REMOVED***
        ...
        ***REMOVED***
        ...
        {
            var stylesheet = AssetDatabase.LoadAssetAtPath<StyleSheet>($"{path***REMOVED***.uss");
            var ussSkinPath = EditorGUIUtility.isProSkin ? $"{path***REMOVED***Dark.uss" : $"{path***REMOVED***Light.uss";
        ...
        ***REMOVED***
        ...
        {
            ApplyStyle(target, $"{ZibraAIPackage.UIToolkitControlsPath***REMOVED***/{name***REMOVED***/{name***REMOVED***");
        ***REMOVED***
    ***REMOVED***
***REMOVED***
#endif
