...
namespace com.zibra.common.Foundation.UIElements
{
    ...
    internal sealed class ButtonStrip : VisualElement
    {
        ...
        ***REMOVED***
        ...
        /// <exclude/>
        /// </summary>
        internal new class UxmlTraits : BindableElement.UxmlTraits {***REMOVED***
        ...
        /// </summary>
        internal string Value { get; set; ***REMOVED***
        ...
        /// </summary>
        public ButtonStrip() : this(new[] { "LEFT", "MIDDLE", "RIGHT" ***REMOVED***)
        {
        ***REMOVED***
        ...
        internal ButtonStrip(IEnumerable<string> choices)
        {
            ...
            m_TextField = new TextField { viewDataKey = "view-data" ***REMOVED***;
            m_TextField.style.display = DisplayStyle.None;
            Add(m_TextField);

            // This is only possible when data is restored.
            m_TextField.RegisterValueChangedCallback(e => { SetValue(e.newValue); ***REMOVED***);
        ***REMOVED***
