...
namespace com.zibra.common.Foundation.UIElements
{
    ...
    internal class HelpBox : BindableElement
    {
        ...
        ***REMOVED***
        ...
        {
            private readonly UxmlStringAttributeDescription m_Text = new UxmlStringAttributeDescription { name = "text" ***REMOVED***;
            private readonly UxmlEnumAttributeDescription<MessageType> m_Type =
                new UxmlEnumAttributeDescription<MessageType> { name = "type" ***REMOVED***;
        ...
        ***REMOVED***
        ...
        /// The message text.
        /// </summary>
        internal string Text { get; set; ***REMOVED***

        /// <summary>
        /// The type of message.
        /// </summary>
        internal MessageType MessageType { get; set; ***REMOVED***
        ...
        public HelpBox()
        {
            Add(new IMGUIContainer(() =>
                                { EditorGUILayout.HelpBox(Text, MessageType, true); ***REMOVED***));
        ***REMOVED***
    ***REMOVED***
***REMOVED***