        ...
        ***REMOVED***
        ...
        private void OnGUI()
        {
            ...
            GUI.Box(new Rect(START_X + x * BOX_WIDTH, startY + y++ * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT),
                    $"OS: {SystemInfo.operatingSystem***REMOVED***");
            GUI.Box(new Rect(START_X + x * BOX_WIDTH, startY + y++ * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT),
                    $"Graphics API: {SystemInfo.graphicsDeviceType***REMOVED***");
            GUI.Box(new Rect(START_X + x * BOX_WIDTH, startY + y++ * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT),
                    $"Unity version: {Application.unityVersion***REMOVED***");
            GUI.Box(new Rect(START_X + x * BOX_WIDTH, startY + y++ * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT),
                    $"Scripting backend: {ScriptingBackend***REMOVED***");
            GUI.Box(new Rect(START_X + x * BOX_WIDTH, startY + y++ * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT),
                    $"Render pipeline: {CurrentRenderPipeline***REMOVED***");
            GUI.Box(new Rect(START_X + x * BOX_WIDTH, startY + y++ * BOX_HEIGHT, BOX_WIDTH, BOX_HEIGHT),
                    $"{SystemInfo.renderingThreadingMode***REMOVED***");
