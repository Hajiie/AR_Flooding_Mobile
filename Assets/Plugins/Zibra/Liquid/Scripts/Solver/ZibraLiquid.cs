...
#region Properties
        ...
        ***REMOVED***
        ...
        /// </remarks>
        public ComputeBuffer PositionMass { get; private set; ***REMOVED***
        ...
        ///     </para>
        /// </remarks>
        public ComputeBuffer[] Affine { get; private set; ***REMOVED***
        ...
        /// </remarks>
        public ComputeBuffer ParticleNumber { get; private set; ***REMOVED***
        ...
        ***REMOVED***
        ...
        {
            get { return _SimulationGUID; ***REMOVED***
        ***REMOVED***
        ...
        ///     </para>
        /// </remarks>
        public int CurrentInstanceID { get; private set; ***REMOVED***

        /// <summary>
        ///     Timestep used in last simulation iteration.
        /// </summary>
        public float Timestep { get; private set; ***REMOVED*** = 0.0f;

        /// <summary>
        ///     Simulation time passed (in simulation time units).
        /// </summary>
        public float SimulationInternalTime { get; private set; ***REMOVED*** = 0.0f;

        /// <summary>
        ///     Number of simulation iterations done so far.
        /// </summary>
        public int SimulationInternalFrame { get; private set; ***REMOVED*** = 0;
        ...
        /// </remarks>
        public int GridNodeCount { get; private set; ***REMOVED*** = 0;
        ...
        ***REMOVED***
        ...
        ///     </para>
        /// </remarks>
        public Vector3Int GridSize { get; private set; ***REMOVED***
        ...
        ///     </para>
        /// </remarks>
        public int CurrentParticleNumber { get; private set; ***REMOVED*** = 0;
        ...
        ///     </para>
        /// </remarks>
        public float NodeSize { get; private set; ***REMOVED***
        ...
        ***REMOVED***
        ...
        ///     </para>
        /// </remarks>
        public bool Initialized { get; private set; ***REMOVED*** = false;
            ...
            ***REMOVED***
            ...
            try
            {
                ...
                ***REMOVED***
                ...
                {
                    string errorMessage =
                        $"License wasn't verified. {LicensingManager.Instance.GetErrorMessage(PluginManager.Effect.Liquid)***REMOVED*** Liquid won't run in editor.";
                ...
                ***REMOVED***
                ...
                SolverCommandBuffer = new CommandBuffer { name = "ZibraLiquid.Solver" ***REMOVED***;
        ...
        ***REMOVED***
        ...
        public List<string> GetStats()
        {
            ...
            return new List<string> {
                ...
                $"Grid size: {GridSize***REMOVED***",
                $"Render resolution: {ResolutionScale * 100.0f***REMOVED***%",
                $"Render pixel count: {PixelCountScale * 100.0f***REMOVED***%",
                $"Max particle count: {MaxNumParticles***REMOVED***",
                $"Current particle count: {CurrentParticleNumber***REMOVED***"
            ***REMOVED***;
        ***REMOVED***
                ...
                if (!CameraCBs.ContainsKey(cam) || isDirty)
                {
                    ...
                    ***REMOVED***
                    else
                    {
                        ...
                        renderCommandBuffer = new CommandBuffer { name = "ZibraLiquid.Render" ***REMOVED***;
